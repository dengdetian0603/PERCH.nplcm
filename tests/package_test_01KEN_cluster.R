...
data.dir = "/home/bst/student/ddeng/PERCH/data/"
code.dir = "/home/bst/student/ddeng/PERCH/PERCH.GitRepo/R/"
new.code.dir = "/home/bst/student/ddeng/PERCH/PERCH.GitRepo/Misc/"
test.result.dir = "/home/bst/student/ddeng/PERCH/test.result/"
openbugs.model.dir = "/home/bst/student/ddeng/PERCH/PERCH.GitRepo/openbugs_models/"
OpenBUGS.dir = "/home/bst/student/ddeng/R/OpenBUGS/lib/bin/OpenBUGS"

code.list = paste(code.dir,dir(code.dir),sep="")
sapply(code.list,source,.GlobalEnv)
...
RawMeasDir <- paste(data.dir,"PQ_20JUN14.csv",sep="")
...
MeasDir    <- paste(data.dir,"PERCH_data_with_newSITE.csv",sep="")

PathCatDir <- paste(data.dir,"pathogen_category.csv",sep="")

write.csv(PERCH_data_with_newSITE,MeasDir)
#PERCH_data_with_newSITE = read.csv(paste(data.dir,"PERCH_data_with_newSITE.csv",sep=""))
...
# or NPPCR(ctrls):
complete_case_index <- which(rowMeans(is.na(datacase$NPPCR[,(length(silver.only)+1):length(Pathogen)]))==0 & #### adjust on silver only # edited by Detian
...
#         across the same category of pathogens
      ...
      fname   <- paste0(test.result.dir,Date,"_",sitename)
      dir.create(fname)
      fullname <- fname
      ...
      bugs.model.dir <- openbugs.model.dir
      winbugs.dir    <- OpenBUGS.dir    ################# use the same variable name but contains dir to OpenBUGS
