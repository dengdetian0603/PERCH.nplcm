...
## zhenkewu@gmail.com
## Detian Deng editted Jul 21st, 2014
###############################################################################
##------------------------------------------------------------------------##
...
call.bugs <- function(data, inits, parameters, m.file,
                      ...
                      bugsmodel.dir= "/home/bst/student/ddeng/PERCH/code/openbugs/",
...
bugs_extraction = function(fullname,VarName,ParameterList){
  simsMat = read.coda(paste(fullname,"CODAchain1.txt",sep="/"),
...
#   Bdat=MBS;Gdat=MGS
  ...
  if (nppcr.bcx.fit){
    ...
    simsMat = read.coda(paste(curr.folder,"CODAchain1.txt",sep="/"),
...
visualize_poppie_pathogen_category = function(directoryName,
  ...
  pckg = try(require(R2OpenBUGS))
  if(!pckg) {
    cat("Installing 'R2OpenBUGS' from CRAN\n")
    getPckg("R2OpenBUGS")
    require("R2OpenBUGS")
  }
